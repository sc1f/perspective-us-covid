...
const Highcharts = highcharts; // cache prototypes
...
export const COLORS_20 = ["#1f77b4", "#aec7e8", "#ff7f0e", "#ffbb78", "#2ca02c", "#98df8a", "#d62728", "#ff9896", "#9467bd", "#c5b0d5", "#8c564b", "#c49c94", "#e377c2", "#f7b6d2", "#7f7f7f", "#c7c7c7", "#bcbd22", "#dbdb8d", "#17becf", "#9edae5"];
...
(function (H) {
  ...
  H.seriesTypes.sunburst.prototype.translateColors = function () {
    ...
    H.each(this.data, function (point) {
      var value = point[colorKey],
          color;
      color = point.options.color || (!point.value // LINE CHANGED
      ? nullColor : colorAxis && value !== undefined ? colorAxis.toColor(value, point) : point.color || series.color);
  ...
  H.seriesTypes.sunburst.prototype.colorKey = "colorValue"; // Pushes part of grid to path
  ...
  axisProto.render = function () {
    ...
    var axis = this,
        ...
        tickWidth = axis.tickWidth; // render grid path for the first time
    ...
    if (!grid) {
      ...
      }).add(axis.axisGroup); // for styled mode - add class
