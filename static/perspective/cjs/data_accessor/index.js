...
var _date_parser = require("./date_parser.js");
...
class DataAccessor {
  constructor() {
    ...
    this.date_validator = val => (0, _date_parser.is_valid_date)(val);
  }
  ...
  marshal(column_index, row_index, type) {
    ...
    if (this.date_parsers[column_name] === undefined) {
      this.date_parsers[column_name] = new _date_parser.DateParser();
    }
