...
export class PerspectiveTabBarRenderer extends TabBar.Renderer {
  ...
  renderTab(data) {
    ...
    const dataset = this.createTabDataset(data); // eslint-disable-next-line prettier/prettier
    ...
    return h.li({
      ...
      style,
      dataset
    }, this.renderConfigIcon(), this.renderLabel(data), this.renderCloseIcon(data), h.div({
      className: "divider"
    }));
  }
